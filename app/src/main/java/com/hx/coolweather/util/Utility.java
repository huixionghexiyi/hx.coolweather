...
/**
 * Province 省 ：id,name,code
 * City     市 : id,name,code,provinceId
 * county   县 : id,name,cityId,weatherId
 */
...
public class Utility {
    ...
    public static boolean handleCityResponse(String response,int provinceId)  {
        if(!TextUtils.isEmpty(response)){
            ...
            try {
                JSONArray  allCities = new JSONArray(response);//获取所有的市级数据
